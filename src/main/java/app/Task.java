...
import static app.Colors.SOLVER_COLOR;
    ...
    public void solve() {
        ...
        for (int i = 0; i < circles.size(); i++) {
            for (int j = i + 1; j < circles.size(); j++) {
                ...
                double tmp_ab_r=a.radius-b.radius;
                if (tmp_ab_r + Math.min(a.radius,b.radius) < Math.max(a.radius,b.radius)){
                    continue;
                }
                ...
                cross = true;
                double x1=0,x2=0,y1=0,y2=0,ka=0,kb=0,kc=0;
//!!!!!! Написать решение квадратного уравнения
    ...
    public void click(Vector2i pos, MouseButton mouseButton) {
        ...
        //!!!!!!!! Сделать по левой кнопке задание центра и ожидание правой кнопки (сообщение)
        // по правой кнопке задание радиуса (точкой на окружности)
